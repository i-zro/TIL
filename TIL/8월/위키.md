...
초기에는 컨테이너에 대한 개념도 부족했고, AWS를 활용하여 flask 서버를 돌려본 게 전부였으며, CI/CD 구축 자체에 대한 경험이 없어서 CI/CD 구축 이나 RDS 구축 만으
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNTUxNzAwNDgzLC0xODU1ODQ2Nzg5LDE1OD

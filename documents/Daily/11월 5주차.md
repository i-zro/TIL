...
## Feeling
- 221129 (화) : 근무를 시작한 지도 70일이 넘었다. 적응이 안될 것만 같았던 회사는 이제 내집인냥 편해졌다만, 한 없이 마음이 무겁다. 내가 무엇을 간절히 하고 싶은 지 말할 수가 없다. 진심으로 무엇을 하고 싶은 건지 나도 나를 모르겠다. 오늘 아침 유진 선임님이 커피를 사주실 때 무슨 역할을 하고 싶냐고 물어보셔서 설비나 네트워크 분야 제외하고는 뭘 하고 싶은 지 결정을 못 내렸다고 했다. 무엇을 할 지 결정 못하겠는 거라면 하기 싫은 것도 없어야 맞다는 답변을 들 커피를 마시고 돌아와서 팀장님께 원하는 R&R을 말하기 전까지, 말씀을 드린 후 지금 까지도 머릿 속이 너무 복잡하다. 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTI5Mzg5NDA3LDExNDU5MjUwOSwxNTM2MT
